...
# Generated by qmake (3.0) (Qt 5.0.2) on: fre. sep. 5 19:16:42 2014
# Project:  Project1/Project1.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 -o Makefile Project1/Project1.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -IProject1 -I/usr/include/qt5 -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -larmadillo -lQt5Gui -L/usr/lib/x86_64-linux-gnu -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = Project1/project1b.cpp \
		Project1/print.cpp 
OBJECTS       = project1b.o \
		print.o
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		Project1/Project1/Project1.pro \
...
Makefile: Project1/Project1.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 -o Makefile Project1/Project1.pro
...
dist: 
	@test -d .tmp/Project11.0.0 || mkdir -p .tmp/Project11.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Project11.0.0/ && $(COPY_FILE) --parents Project1/print.h .tmp/Project11.0.0/ && $(COPY_FILE) --parents Project1/project1b.cpp Project1/print.cpp .tmp/Project11.0.0/ && (cd `dirname .tmp/Project11.0.0` && $(TAR) Project11.0.0.tar Project11.0.0 && $(COMPRESS) Project11.0.0.tar) && $(MOVE) `dirname .tmp/Project11.0.0`/Project11.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Project11.0.0
...
project1b.o: Project1/project1b.cpp Project1/print.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o project1b.o Project1/project1b.cpp

print.o: Project1/print.cpp Project1/print.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o print.o Project1/print.cpp
